...
export default function AsistenciaIndex() {
  ...
  return (
    <div className="mx-auto max-w-7xl pb-12">
      <div className="mb-8">
        <h1 className="mb-2 text-3xl font-bold text-neutral-800 dark:text-neutral-100">Control de Asistencia</h1>
        <p className="text-base font-medium text-neutral-500 dark:text-neutral-400">Selecciona un curso para registrar, consultar el historial y ver la lista final de asistencia.</p>
      </div>
