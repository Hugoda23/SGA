...
export default function ReporteListadoAlumnos() {
  ...
  const [search, setSearch] = useState(searchParams.get('curso') || '')
  ...
  return (
    <div className="max-w-7xl mx-auto pb-12">
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-neutral-800 dark:text-neutral-100 mb-2">Listado de Alumnos</h1>
        <p className="text-base font-medium text-neutral-500 dark:text-neutral-400">Genera y descarga en PDF el listado de alumnos inscritos, filtrando por curso, grado y sección.</p>
      </div>
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan="7" className="px-4 py-12 text-center text-neutral-500">
                    ...
                    <p className="text-sm text-neutral-400">Crea asignaciones para poder generar el listado.</p>
                  </td>
                </tr>
              ) : (
                filtered.map((row) => (
